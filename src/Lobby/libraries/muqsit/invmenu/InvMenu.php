...
use Closure;
use Lobby\libraries\muqsit\invmenu\inventory\SharedInvMenuSynchronizer;
use Lobby\libraries\muqsit\invmenu\session\InvMenuInfo;
use Lobby\libraries\muqsit\invmenu\session\network\PlayerNetwork;
use Lobby\libraries\muqsit\invmenu\transaction\DeterministicInvMenuTransaction;
use Lobby\libraries\muqsit\invmenu\transaction\InvMenuTransaction;
use Lobby\libraries\muqsit\invmenu\transaction\InvMenuTransactionResult;
use Lobby\libraries\muqsit\invmenu\transaction\SimpleInvMenuTransaction;
use Lobby\libraries\muqsit\invmenu\type\InvMenuType;
use Lobby\libraries\muqsit\invmenu\type\InvMenuTypeIds;
use LogicException;
...
class InvMenu implements InvMenuTypeIds{
	...
	/**
	 * @param (Closure(\Lobby\libraries\muqsit\invmenu\transaction\DeterministicInvMenuTransaction) : void)|null $listener
	 * @return Closure(\Lobby\libraries\muqsit\invmenu\transaction\InvMenuTransaction) : \Lobby\libraries\muqsit\invmenu\transaction\InvMenuTransactionResult
	 */
	...
	/**
	 * @return (Closure(\Lobby\libraries\muqsit\invmenu\transaction\InvMenuTransaction) : InvMenuTransactionResult)|null
	 */
	...
	/**
	 * @param (Closure(\Lobby\libraries\muqsit\invmenu\transaction\InvMenuTransaction) : \Lobby\libraries\muqsit\invmenu\transaction\InvMenuTransactionResult)|null $listener
	 * @return self
	 */
