...
use Lobby\libraries\CortexPE\Commando\store\SoftEnumStore;
use Lobby\libraries\CortexPE\Commando\traits\IArgumentable;
use Lobby\libraries\muqsit\simplepackethandler\SimplePacketHandler;
...
class PacketHooker implements Listener {
	...
	/**
	 * @param \Lobby\libraries\CortexPE\Commando\traits\IArgumentable $argumentable
	 *
	 * @return CommandOverload[]
	 */
